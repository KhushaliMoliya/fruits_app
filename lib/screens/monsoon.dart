...
class MonsoonPage extends StatefulWidget {
  const MonsoonPage({super.key});

  @override
  State<MonsoonPage> createState() => _MonsoonPageState();
}

class _MonsoonPageState extends State<MonsoonPage> {
  ...
  final List<Map<String, String>> fruits = [
    {
      ...
      "price": "₹40/kg",
      "oldPrice": "₹50/kg",
      "image": "assets/dregon.png"
    },
    {
      "name": "Peaches",
      "price": "₹120/kg",
      "oldPrice": "₹140/kg",
      "image": "assets/peaches.png"
    },
    {
      "name": "Jamun",
      "price": "₹100/kg",
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (_) => ProductDetailPage(
                          ...
                          image: fruit["image"]!,
                          description:
                          "${fruit["name"]} is a healthy Monsoon fruit rich in vitamins.",
                        ),
                      ),
                    );
                  },
